		...
		this.loginBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ret.equals("login success.")) {
					...
					Toolkit.getDefaultToolkit().beep();
					JOptionPane.showMessageDialog(null, "登录失败！账号或密码错误", "Login failed.", JOptionPane.WARNING_MESSAGE);
				}
			}
		...
		this.registerBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ret.equals("register success.")) {
					...
					Toolkit.getDefaultToolkit().beep();
					JOptionPane.showMessageDialog(null, "注册成功！", "Register success.", JOptionPane.PLAIN_MESSAGE);
				}else {
					System.out.println("注册失败。");
					Toolkit.getDefaultToolkit().beep();
					JOptionPane.showMessageDialog(null, "注册失败！用户名已被占用。", "Register failed.", JOptionPane.WARNING_MESSAGE);
				}
			}
		});
	}
